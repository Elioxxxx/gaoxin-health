...
import { updateDoctorServiceLeadStatus } from "@/server/mutations/service-lead-mutation"
...
export async function PUT(request: Request, context: RouteContext<{ id: string }>) {
  ...
  try {
    ...
    await safeAuditLog({
      ...
      action: "DOCTOR_UPDATE_SERVICE_LEAD_STATUS",
    ...
    return handleApiError(error, "doctor_service_lead_update_failed", "医生端服务线索更新失败")
  }
}
